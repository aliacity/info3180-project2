...
def userDetails(user_id):
    try:
        ...
        current = {"firsname": user.firstname, "lname": user.lastname, "user_photo": os.path.join(app.config['GET_FILE'], user.profile_photo), "location": user.location, "biography": user.biography, "joined": user.joined_on.strftime("%b %Y"), "postNum": len(user.posts), "followers": len(user.followers), "posts": []}
