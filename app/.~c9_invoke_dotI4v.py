...
def userDetails(user_id):
    try:
        ...
        "profile_photo": os.path.join(app.config['GET_FILE'], user.profile_photo), "joined": user.joined_on.strftime("%b %Y")"postNum": len(user.posts), "followers": len(user.followers), "posts": []}
